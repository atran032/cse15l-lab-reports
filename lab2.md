...
## Part 3
I learned a lot from the past 2 labs. One thing I didn't know before was how to use URLs in creating servers and having some effects on pieces of code. I found it very interesting that different paths can make the code do and display different things. After writing my own server to add strings to a list, I think I more thoroughly understand how this is done using methods such as getPath() and getQuery().
